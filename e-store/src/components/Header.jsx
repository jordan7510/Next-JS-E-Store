    ...
    return (
        <header className='bg-white bg-opacity-50 rounded-md shadow backdrop-blur-sm border-gray-400 p-4 z-40 sticky'>
            <Container className={'flex items-center justify-between'}>
                ...
                {/* Search bar */}
                <div className='max-w-[500px] border rounded-full flex items-center'>
                    <input
                        className='text-slate-700 outline-0 w-[100%] px-2 py-2'
                        placeholder='Search for Products'
                        type="text" />
                    <div className='bg-pink-600 ml-5 flex items-center justify-center '>
                        <button className='text-white' ><FiSearch size={18} /></button>
                    </div>
                </div>
                <NavBar />
            </Container>
